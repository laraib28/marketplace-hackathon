...
const ProductPage = () => {
  ...
  const [product, setProduct] = useState<ViewAll | null>(null);
  ...
  useEffect(() => {
    if (slug) {
      const fetchProduct = async () => {
        ...
        try {
          const products: ViewAll[] = await client.fetch(query, { slug });
  ...
  // In your ViewAll Component, ensure that the `handleAddToCart` is working properly.
